...
The simplied XML processing library can be directly integrated into a code by third party software or can be used to create new application from people who dosn't want to deal with the complexity of XML. Although simplied and somewhat restricted compared to a full-
...
The TIXI library is written in C, but there are interfaces and wrappers for C++, Fortran, Python, JAVA and Matlab. Take a look at our [usage examples](http://code.google.com/p/tixi/wiki/UsageExamples) for specific examples.
