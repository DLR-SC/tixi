...
This is an example how to use TIXI with fortran 77. The program uses a lot of TIXI functions so you can get the idea how to use it.

You can find the most recent version of the code in our [repository](http://code.google.com/p/tixi/source/browse/trunk/Src/testf77.f) as well.
