...
TEST_F(ArrayTests, array_test_positive)
{
    ...
    pos[0] = 0; pos[1] = 0; pos[2] = 0; pos[3] = 0; ASSERT_TRUE ( tixiGetArrayValue(values, sizes, pos, dims) == 1.0 );   // [0][0][0][0]
    pos[0] = 0; pos[1] = 0; pos[2] = 0; pos[3] = 1; ASSERT_TRUE ( tixiGetArrayValue(values, sizes, pos, dims) == 2.0 );   // [0][0][0][1]
    pos[0] = 0; pos[1] = 0; pos[2] = 1; pos[3] = 1; ASSERT_TRUE ( tixiGetArrayValue(values, sizes, pos, dims) == 12. );   // [0][0][1][1]
    pos[0] = 0; pos[1] = 1; pos[2] = 1; pos[3] = 0; ASSERT_TRUE ( tixiGetArrayValue(values, sizes, pos, dims) == 201 );   // [0][1][1][0]
}
